...
/* نخزّن كل عنصر على حدة (add لكلٍّ مع catch) كي لا يُفشل غيابُ ملفٍ اختياري التخزينَ المسبق كلّه.
   الأيقونات ملفات فعلية (الشعار الجديد)، ولها بديل مضمّن داخل index.html إن غابت. */
const SHELL = [
  "./",
  "./index.html",
  "./config.js",
